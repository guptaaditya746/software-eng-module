...
public class passwordEngine{
    ...
    protected static long collectEntropy() {
        long entropy = 0;
        entropy ^= System.nanoTime();
        return entropy;
    }

    protected static int generateRandomNumber(int max) {
    ...
    //the code is taking random passwords whose length is a fixed value
